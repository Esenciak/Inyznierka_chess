...
public class SceneExitPrompt : MonoBehaviour
{
        ...
        private void BuildResignButton()
        {
                ...
                Canvas canvas = promptRoot.GetComponentInParent<Canvas>();
                if (canvas == null)
                {
                        return;
                }

                resignButton = CreateButton(canvas.transform, "ResignButton", resignButtonLabel, new Vector2(0.78f, 0.9f), new Vector2(0.97f, 0.98f));
